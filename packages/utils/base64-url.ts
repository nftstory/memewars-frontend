...
import { AsciiString, Base64String, Base64URLString } from './zod'
...
export function base64urlStringToBase64(base64urlString: Base64URLString): Base64String {
    return base64.fromArrayBuffer(base64UrlStringtoBuffer(base64urlString)) as Base64String
}
...
export function base64UrlStringToAscii(base64urlString: Base64URLString): AsciiString {
