...
const exportedColors = [
  {
    paltteName: "Primaries",
    swatches: [
      { name: "prim-50", color: "DCFFFE" },
      { name: "prim-100", color: "CDF7F6" },
      { name: "prim-200", color: "ADE6E3" },
      { name: "prim-300", color: "89CECB" },
      { name: "prim-400", color: "67B5B2" },
      { name: "prim-500", color: "529895" },
      { name: "prim-600", color: "417A77" },
      { name: "prim-700", color: "325D5B" },
      { name: "prim-800", color: "1E3937" },
      { name: "prim-900", color: "0B1414" },
      { name: "prim-950", color: "010202" }
    ]
  }
]
