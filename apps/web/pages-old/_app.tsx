...
import { SessionProvider } from '../../../packages/app/provider/session'
...
}: SolitoAppProps<Pick<React.ComponentProps<typeof NextAuthSessionProvider>, 'session'>>) {
  return (
    <>
      <Head>
        {/* 
        ...
        */}
        ...
        <style
          id="expo-reset"
          /* biome-ignore lint/security/noDangerouslySetInnerHtml: This breaks if it is imported as above ¯\_(ツ)_/¯ */
